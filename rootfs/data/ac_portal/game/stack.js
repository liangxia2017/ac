...
var net_time;
 ...
 function firstinit() {
  ...
  document.getElementById('yourbest').innerHTML=theirbest;
    if(theirbest > 300){
        document.getElementById('net_time').innerHTML=parseInt(theirbest/10);
    }else{
        document.getElementById('net_time').innerHTML=0;
    }
...
function gameover() {
 ...
 if(stscore>theirbest) {
  ...
  if(stscore > 300){
        document.getElementById('net_time').innerHTML=parseInt(stscore/10);
    }else{
        document.getElementById('net_time').innerHTML=0;
    }
    
  theirbest=stscore;
  net_time = theirbest>300 ? parseInt(theirbest/10):0;  
  ialert('<h1>游戏结束: '+stscore+'分</h1><div style="margin: 20px;">厉害，你破纪录了<br /><br />新记录为<span style="color: red;">'+theirbest+'</span>分<br /><br />提交后将获得<span style="color: red;">'+net_time+'</span>分钟上网时长</div>','restartgame();',net_time);
 } else {
  ialert('<h1>游戏结束: '+stscore+'分</h1><div style="margin: 20px;">记录为<span style="color: red;">'+theirbest+'</span>分<br /><br />提交后将获得<span style="color: red;">'+net_time+'</span>分钟上网时长</div>','restartgame();',net_time);
 }
...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://games.vdcom.cn/games/duimutou/icon.png",
		url: "http://games.vdcom.cn/games/duimutou/",
